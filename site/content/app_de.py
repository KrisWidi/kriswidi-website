...
HOME_BLOCKS = [
    ...
    {"type": "split", "bg": "sand", "frame": True, "image": "app-mein-tag", "alt": "Ansicht „Mein Tag“ in der Betriebs-App: Stempeluhr und heutige Termine",
     ...
     "paragraphs": ["Kommen, Pause, Gehen. Darunter die Termine des Tages mit Adresse und Aufgaben. Mehr braucht dein Mitarbeiter nicht zu sehen – und mehr sieht er auch nicht. Und zwar in seiner Sprache – du planst auf Deutsch, er liest auf Russisch, Spanisch oder Arabisch."],
